...
function init() {
	...
	} else if (type == 'Cурьма, полиметаллы') {
    ...
    var surma_button = new ymaps.control.Button('Сурьма, полиметаллы');
